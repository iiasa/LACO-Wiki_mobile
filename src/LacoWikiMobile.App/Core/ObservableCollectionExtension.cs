...
namespace LacoWikiMobile.App.Core
{
	...
	{
		public static T OnChildrenPropertyChanged<T>(this T enumerable, PropertyChangedEventHandler callback) where T : IEnumerable
		{
			foreach (INotifyPropertyChanged item in enumerable.OfType<INotifyPropertyChanged>())
			{
		...
		public static T OnObservableCollectionChildrenPropertyChanged<T>(this T collection, PropertyChangedEventHandler callback)
